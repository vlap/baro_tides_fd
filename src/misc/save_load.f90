...
!----------------------- UPDATE SOLUTION ----------------------------
!====================================================================
subroutine save_solution(nu, nv, nh, itn, cpt, uvh, p_avg, dir_sols)
...
!---------------------------- SAVE DIRECTORIES --------------------------
!==========================================================================================
subroutine make_save_dirs(isave, now, len_out, output_dir, dir_cols, dir_grid, dir_mats, dir_sols, dir_global)
